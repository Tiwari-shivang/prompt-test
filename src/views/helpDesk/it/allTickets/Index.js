...
const Index = () => {
	const { data: AllTicketForItDashboard, isLoading } = useGetTicketsForItDashboard()
			...
			<div className='allTickets'>
				...
				}
				{
					<>
						...
						{
							AllTicketForItDashboard && AllTicketForItDashboard.it_admin_ticket?.map(
