...
const ProjectHealthDetail = ({ show, handleClose, projectData, latestHealth }) => {
    ...
    useEffect(() => {
        if (projectData) {
            ...
            setViewData({
                ...
                reasonForAmber: health?.reason_for_amber_or_red || "",
    ...
    const mapProjectHealthData = () => {
        ...
        return {
            ...
            reason_for_amber_or_red: viewData.reasonForAmber,
                      ...
                      <Col xs={6}>
                          <Form.Group className="mb-3">
                            ...
                            <Form.Select
                              ...
                              className={error.projectType ? "is-invalid" : ""} 
                            >
                              <option value="" disabled hidden>
                                Select Project Type
                              </option>
                        ...
                        <Col md={6}>
                          <Form.Group className="mb-3">
                            ...
                            <Form.Select
                              ...
                              className={error.projectStatus ? "is-invalid" : ""} 
                            >
                              <option value="" disabled hidden>
                        ...
                        <Col xs={6}>
                          <Form.Group className="mb-3">
                            ...
                            <Form.Select
                              ...
                              className={error.pricingModel ? "is-invalid" : ""}
                            >
                              <option value="" disabled hidden>
                        ...
                        <Col xs={6}>
                          <Form.Group className="mb-3">
                            ...
                            <Form.Control
                              ...
                              className={error.baselineStart ? "is-invalid" : ""} 
                            />
                          </Form.Group>
                        </Col>
                        <Col md={6}>
